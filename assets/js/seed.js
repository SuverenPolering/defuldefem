...
(function () {
  ...
  /* ---------- BØDEKASSENS VEDTÆGTER (officielt dokument) ---------- */
  var BOEDEKASSE_VEDTAEGT = [
    '§ 1',
  ...
  window.seed = function seed() {
    ...
    var members = [
      ...
      { id: 'steffen', navn: 'Steffen Due Lund', titel: 'Joy',                    initial: 'S', rolle: 'joy' },
      { id: 'gaest',   navn: 'Gæst',             titel: 'Gæst',                   initial: 'G', rolle: 'gaest' }
    ];
    W('members', members);
    ...
    W('vedtaegter', {
      ...
      boedekasse: BOEDEKASSE_VEDTAEGT
    });
